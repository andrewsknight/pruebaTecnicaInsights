...
-- Eliminar TODOS los foreign keys
...
ALTER TABLE system_metrics DROP CONSTRAINT IF EXISTS system_metrics_tenant_id_fkey;

-- Convertir TODAS las tablas a VARCHAR
...
ALTER TABLE system_metrics ALTER COLUMN id TYPE VARCHAR USING id::text;
ALTER TABLE system_metrics ALTER COLUMN tenant_id TYPE VARCHAR USING tenant_id::text;
ALTER TABLE test_runs ALTER COLUMN id TYPE VARCHAR USING id::text;

-- Recrear solo los foreign keys esenciales (sin tenant por ahora)
